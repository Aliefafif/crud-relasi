...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"><?php echo e(__('Edit Buku')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($buku->foto): ?>
                                <div class="mb-2">
                                    <img src="<?php echo e(Storage::url('buku/' . $buku->foto)); ?>" alt="Foto Buku" class="img-thumbnail" width="150">
                                </div>
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   name="foto" value="<?php echo e($buku->foto); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_alief\resources\views/buku/edit.blade.php ENDPATH**/ ?>