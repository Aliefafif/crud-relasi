                    ...
                    <div class="col-lg-10">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                     ...
                                     <a href="<?php echo e(route('kategori.create')); ?>" class="btn btn-sm btn-primary">Tambah</a>
                                </div>
                                <!-- /.panel-heading -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?php echo e(route('kategori.destroy', $data->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <a href="<?php echo e(route('kategori.edit', $data->id)); ?>" class="btn btn-success">Edit</a>|
                                        <a href="<?php echo e(route('kategori.show', $data->id)); ?>" class="btn btn-warning">Show</a>|
...
<?php /**PATH C:\xampp\htdocs\laravel_alief\resources\views/kategori/index.blade.php ENDPATH**/ ?>