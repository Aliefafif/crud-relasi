                    ...
                    <div class="col-lg-10">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                     ...
                                     <a href="<?php echo e(route('produk.create')); ?>" class="btn btn-sm btn-primary">Tambah</a>
                                </div>
                                <!-- /.panel-heading -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="row"><?php echo e($data->nama_produk); ?></td>
                                <td scope="row"><?php echo e($data->harga); ?></td>
                                <td scope="row"><?php echo e($data->stok); ?></td>
                                <td scope="row"><?php echo e($data->kategori->nama); ?></td>
                               
                                <td>
                                    <form action="<?php echo e(route('produk.destroy', $data->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <a href="<?php echo e(route('produk.edit', $data->id)); ?>" class="btn btn-success">Edit</a>|
                                        <a href="<?php echo e(route('produk.show', $data->id)); ?>" class="btn btn-warning">Show</a>|
...
</html><?php /**PATH C:\xampp\htdocs\laravel_alief\resources\views/produk/index.blade.php ENDPATH**/ ?>