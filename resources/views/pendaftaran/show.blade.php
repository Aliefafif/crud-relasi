                                    ...
                                    <form action="{{ route('pendaftaran.store') }}" method="post" enctype="multipart/form-data">
                                     ...
                                     @method('PUT')
                                        <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $pendaftaran->nama_lengkap }}" disabled>
                                         </div>
                                          <div class="form-group">
                                                        <label> Jenis Kelamin <br>
                                                            <input type="text" class="form-control" value="{{ $pendaftaran->jenis_kelamin }}" disabled>
                                                        </label>
                                                    </div>
                                          <div class="form-group">
                                                    <label>Tanggal Lahir</label>
                                                    <input type="text" class="form-control" value="{{ $pendaftaran->tanggal_lahir }}" disabled>
                                         </div>
                                         <div class="form-group">
                                                    <label>Agama</label>
                                         ...
                                         <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $pendaftaran->asal_sekolah }}" disabled>
                                         </div>
